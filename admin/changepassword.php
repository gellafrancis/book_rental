...
function myVal() {
    ...
    <br>  
    <br>
   <center>  <div class="mui-container-fluid" style="padding-top: 8%">
           <div class="row">
             <div class="panel panel-default col-sm-8 col-sm-offset-2 hid" >
              <div class="panel-body">
                ...
                ?>
                        ...
                        <div class='col-sm-12  '>
                                    ...
                                    <font size='6'><b> Change Password</b> </font> 
                           ...
                           <table width="100%"  cellspacing="1" class = "table table-responsive "> 
                              <tr>
                                  <td> <b>Old Password:</b></td>
                                  <td><input class="form-control" type="password" name="oldpassword" value="" required="required" /></td>    
                              </tr>
                          
                              <tr>
                                  <td> <b>New Password:</b></td>
                                  <td> <input class="form-control " type="password" name="password1" value="" required="required" min="8" id="newpass" onkeyup="checklength();" return="false" /></td>
                              </tr>
                               <tr>
                                  <td> <b>Re-type New Password:</b> </td>
                                  <td><input class="form-control" type="password" name="password2" value=""  required="required"  min="8" id="conpass" onkeyup="checkPass();" return="false" /></td>
                              </tr>
                            ...
                            <br>
                            <input type='submit' class="btn btn-success success" style="width:200px;" /> 
                            <a href="admininformation.php"><input name='return' value="Return to Admin's Profile" class="btn btn-warning warning" style="width:200px;"/></a> 
                            <br>
