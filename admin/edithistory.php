...
<!doctype html>
   ...
   <style>
    ...
    <div class="mui-container-fluid">
          ...
          <h1><strong>Edit History</strong></h1>
          <hr>
            <!--  -->
            <form method="POST" > 
  				...
  				<thead>                               
                                <tr class="warning"> 
                                <th scope='cols'> # </th>
                                    <th scope='cols'><center>Date and Time</center> </th>
          ...
          <?php
              ...
              $result = query($sql);
                        ...
                        {
                          echo "<tr>";
                          echo "<td>".$row['log_id']."</td>" . "<td>".$row['log_date']."</td>"."<td>".$row['log_activity']."</td>";
                          echo "<td><center><button class='btn btn-danger btn-block' name = 'logdelete' value = '".$row['log_id']."'>Delete</button></center></td>";  
