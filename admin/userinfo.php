...
<!doctype html>
    ...
    $id=$_SESSION['id'];
         ...
         $query="select * from usr_details where u_id='$id' limit 1";
    ...
    <head>
            ...
            <link rel="stylesheet" href=" " ref="css/bootstrap.min.css" type="text/css">
           ...
           <div class="row">
             <div class="panel panel-default col-sm-10 col-sm-offset-1 hid" >
              <div class="panel-body">
                <div class="row">
          <form method="POST"  role="form" id="formfield" name="mainForm">
                      ...
                      <center><img src="assets/img/nullDP.png" width="10%"></center>
                        <center> <h2><b><?php echo $fn ." ". $ln ?> </b></h2></center> 
                        <br>
                        <br>
              <table width="100%" class="warning">
			 <tr>
                                    <td><h3><b>Information</h3></b>  
                                    <td>
                                    </td>
                                </tr>					
	                       <tr>
			      ...
			      <center>
			          <div> <br> <br>
                                 <button type="button" class="btn btn-warning btn-lg" name="View Log" data-toggle="modal" data-target="#myModal" style="display:block;width:250px;">View Book Logs</button>
              ...
              <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title">Book Logs</h4>
                  </div>
